...
class OpenAICompatibleEmbeddingProvider:
    ...
    def __init__(self, base_url: str, api_key: str, model: str, timeout_seconds: float = 30.0, client: httpx.AsyncClient | None = None, dimensions: int | None = None, expected_dimension: int | None = None) -> None:
