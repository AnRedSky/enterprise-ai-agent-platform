...
def test_chat_stream_requires_bearer_authentication():
    response = client.post(
        ...
        json={"agent_id": "00000000-0000-0000-0000-000000000001", "input": "hello"},
    )
    assert response.status_code == 401


def test_chat_messages_requires_bearer_authentication():
    response = client.get("/api/v1/agents/sessions/00000000-0000-0000-0000-000000000001/messages")
    assert response.status_code == 401
