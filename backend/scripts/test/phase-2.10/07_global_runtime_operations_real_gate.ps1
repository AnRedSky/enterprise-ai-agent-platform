...
Write-Host "============================================================"
Write-Host "Enterprise AI Agent Platform - Phase 2.10-II Global Runtime Operations Real Gate"
Write-Host "============================================================"
...
Write-Host "[2/5] Global Runtime Operations unit + API contract"
...
Write-Host "[4/5] Global Runtime Operations real PostgreSQL acceptance"
uv run pytest -q -m real_api tests/api_real/test_global_runtime_operations_acceptance.py --tb=short
if ($LASTEXITCODE -ne 0) { throw "Global Runtime Operations Real Acceptance failed." }
...
Write-Host "[PASS] Phase 2.10-II Global Runtime Operations Real Gate completed."
