...
import {
  ElAlert, ElButton, ElCard, ElDialog, ElForm, ElFormItem, ElInput, ElInputNumber, ElOption, ElSelect, ElTabPane, ElTable, ElTableColumn, ElTabs, ElTag,
} from "element-plus";
...
const elementComponents = { ElAlert, ElButton, ElCard, ElDialog, ElForm, ElFormItem, ElInput, ElInputNumber, ElOption, ElSelect, ElTabPane, ElTable, ElTableColumn, ElTabs, ElTag };
function mountIntegrations() { return mount(Integrations, { global: { components: elementComponents, directives: { loading: () => undefined } } }); }
