...
beforeEach(() => {
  vi.clearAllMocks();
  vi.mocked(runtimeOperationsApi.global).mockResolvedValue({ data: { window_hours: 24, since: "2026-08-29T00:00:00Z", generated_at: "2026-08-30T00:00:00Z", filters: { workflow_id: null, agent_id: null, trigger_id: null, execution_id: null, execution_status: null }, executions: { total: 8, status_counts: { pending: 1, running: 2, completed: 4, failed: 1 }, active_count: 3, recovery_count: 1, items: [{ id: "ex1", workflow_id: "wf1", workflow_name: "订单处理", status: "running", current_node_id: "node-2", worker_owner: "worker-1", worker_attempt: 1, worker_lease_expires_at: "2026-08-30T00:05:00Z", error_code: null, started_at: "2026-08-29T23:00:00Z", ended_at: null, created_at: "2026-08-29T23:00:00Z" }] }, workflows: { total: 3, status_counts: { active: 2, draft: 1 } }, triggers: { total: 4, status_counts: { enabled: 3, disabled: 1 }, scheduled_enabled: 3 }, worker: { liveness: "unknown", liveness_reason_code: "NO_DURABLE_HEARTBEAT_FACT", running_frontiers: 2, pending_frontiers: 1, leased_frontiers: 2, expired_leases: 1, active_worker_owners: 1 }, scheduler: { liveness: "unknown", liveness_reason_code: "NO_DURABLE_HEARTBEAT_FACT", enabled_scheduled_triggers: 3, durable_frontier_backlog: 1 } } } as never);
