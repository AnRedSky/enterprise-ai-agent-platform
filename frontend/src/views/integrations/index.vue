...
<template>
  <div class="integration-page">
    <div class="page-heading">
      <div class="heading-copy"><div class="eyebrow">PLATFORM / INTEGRATIONS</div><h1>集成中心</h1><p>把平台事件可靠地连接到企业内部系统、告警平台和业务服务。</p></div>
    ...
    <div class="metric-grid">
      ...
      <div class="metric-card"><div class="metric-icon"><Connection /></div><div><span>传输协议</span><strong>Webhook</strong><small>HTTP Event Delivery</small></div></div>
    </div>

    <el-alert title="安全提示" description="Secret 仅通过 Secret 引用关联，页面不会保存或展示 Secret 明文；Endpoint 与 Header 配置属于租户级集成配置。" type="info" :closable="false" show-icon class="security-note" />
