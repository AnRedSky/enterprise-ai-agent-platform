<template>
  <el-card>
    ...
    <el-form inline @submit.prevent><el-input v-model="status" placeholder="Status" clearable /><el-button type="primary" @click="load">查询</el-button></el-form>
...
const items = ref<any[]>([]), page = ref(1), pageSize = ref(20), total = ref(0), status = ref(""), loading = ref(false), error = ref(false);
