...
- `004-playwright-project-missing.md`：Phase 1.6-C Playwright Gate 使用 `--project="Desktop Chrome"`，但原 `playwright.config.ts` 未定义同名 project，导致 Browser E2E 在测试启动前阻塞；已完成配置修复，等待重新执行 E2E Gate。
